<template>
  ...
  >
    <div class="card-content">
      ...
      <div class="center">
        <div class="state">
          <img v-if="level.status === 'completed'" :src="completedIcon" alt="完成" class="status-icon" />
          <img v-else-if="level.status === 'available'" :src="availableIcon" alt="可用" class="status-icon" />
          <img v-else-if="level.status === 'locked'" :src="lockedIcon" alt="锁定" class="status-icon" />
...
// 导入状态图标
import completedIcon from '@/assets/CodeBubbyAssets/20_13/5.svg';
import availableIcon from '@/assets/CodeBubbyAssets/20_13/17.svg';
import lockedIcon from '@/assets/CodeBubbyAssets/20_13/29.svg';
