...
# 导入所有路由
from . import auth, users, games, words, game_sessions, vocabulary, vocabulary_test, levels, vocabulary_game
...
from .vocabulary_game import vocabulary_game_bp
...
api_bp.register_blueprint(vocabulary_game_bp, url_prefix='/vocabulary-game')